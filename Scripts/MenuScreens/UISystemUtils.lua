...
function UI:PlayMusic()
	-- [szczekus] The UI system in FC is a total chaos... you never know when certain functions are called, even tho they shouldn`t
	-- 			 The UI:StopMusic() function for example is called more than 6 times BEFORE you even see the main menu after lauching the game...
