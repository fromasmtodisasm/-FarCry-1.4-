...
void CXSystemBase::StartLoading(bool bEditor)
{
	...
	//////////////////////////////////////////////////////////////////////////
	// Silence everything.
	// [szczekus] Nope. Silence only the MusicSystem.
	//////////////////////////////////////////////////////////////////////////
...
bool CXSystemBase::LoadLevelCommon( SMissionInfo &missionInfo )
{
	...
	// Make level loading image. (ex: Levels\Training\loadscreen_training1.dds)
	// [szczekus] new file path
	string sLoadingScreenTexture = missionInfo.sLevelFolder + "/LOADING/loadscreen_" + missionInfo.sLevelName + "1.jpg";
	...
	// [szczekus] editor stuff, don`t bother
	...
	// Reset console.
	//////////////////////////////////////////////////////////////////////////
	//CryLogAlways("CXSystemBase::LoadLevelCommon Called");
	//CryLogAlways("Progress bar range %i",missionInfo.dwProgressBarRange);
	...
	//CryLogAlways("Progress bar range %i",dwProgressBarRange);
	...
	// Reset old stuff.
	//////////////////////////////////////////////////////////////////////////
	// [szczekus] set new loading image in the console
	sLoadingScreenTexture = missionInfo.sLevelFolder + "/LOADING/loadscreen_" + missionInfo.sLevelName + "2.jpg";
	m_pSystem->GetIConsole()->SetLoadingImage( sLoadingScreenTexture.c_str() );
	...
	//////////////////////////////////////////////////////////////////////////
	// [szczekus]
	sLoadingScreenTexture = missionInfo.sLevelFolder + "/LOADING/loadscreen_" + missionInfo.sLevelName + "3.jpg";
	m_pSystem->GetIConsole()->SetLoadingImage( sLoadingScreenTexture.c_str() );

	// [szczekus] This loads all the objects for the map
	//			  Sadly, we don`t access to it
	...
	//////////////////////////////////////////////////////////////////////////
	// [szczekus]
	sLoadingScreenTexture = missionInfo.sLevelFolder + "/LOADING/loadscreen_" + missionInfo.sLevelName + "4.jpg";
	m_pSystem->GetIConsole()->SetLoadingImage( sLoadingScreenTexture.c_str() );	
	//////////////////////////////////////////////////////////////////////
	// INITIALIZE AI SYSTEM
	IAISystem *pAISystem = m_pSystem->GetAISystem();	
	...
	//////////////////////////////////////////////////////////////////////////
	// [szczekus]
	sLoadingScreenTexture = missionInfo.sLevelFolder + "/LOADING/loadscreen_" + missionInfo.sLevelName + "5.jpg";
	m_pSystem->GetIConsole()->SetLoadingImage( sLoadingScreenTexture.c_str() );	
	//////////////////////////////////////////////////////////////////////////
	// Load level entities.
	//////////////////////////////////////////////////////////////////////////
	...
	//This image will display for most of the time while loading from stream
	//Because of that lets leave the loading/spawning entities loading screen, since 90% loading are going to be entities ;)
	if( !m_pGame->m_bIsLoadingLevelFromFile)		
	{
		sLoadingScreenTexture = missionInfo.sLevelFolder + "/LOADING/loadscreen_" + missionInfo.sLevelName + "6.jpg";
		m_pSystem->GetIConsole()->SetLoadingImage( sLoadingScreenTexture.c_str() );	
	}
	//////////////////////////////////////////////////////////////////////////
	// Load Level Music.
